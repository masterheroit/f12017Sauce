...
static CBaseEntity *GetEntity(IHandleEntity *e)
{
...
inline bool CBaseFilter::ShouldHitEntity(IHandleEntity *pHandle, int contentsMask)
{
	...
	if( pEntCC->iClassID == classId::CFuncRespawnRoomVisualizer || pEntCC->iClassID == classId::CTFMedigunShield || pEntCC->iClassID == classId::CFuncAreaPortalWindow )
	{
		return false;
	}
