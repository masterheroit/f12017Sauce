...
#define COLOR_TEAMTWO /*COLORCODE(255, 25, 25, 255)*/ COLORCODE( 186,52,53, 255 )			// 2
#define COLOR_TEAMTHREE /*COLORCODE(90, 120, 255, 255)*/ COLORCODE( 0, 128, 255, 255 )		// 3
...
public:
	...
	void DrawRadiusBox( int x, int y, int w, int h, int outline, DWORD dwColor );
