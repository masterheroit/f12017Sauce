...
void CDrawManager::Initialize()
{
	...
	addFont(font);
	font.setFont("Arial", 16, 500, CDrawManager::FONTFLAG_OUTLINE, "menuMain");
	addFont(font);
...
//===================================================================================
void CDrawManager::DrawBox( Vector vOrigin, DWORD color, int box_width, int box_height, int radius )
{
	Vector vScreen;
...
//===================================================================================
void CDrawManager::DrawRadiusBox( int x, int y, int w, int h, int outline, DWORD dwColor )
{
